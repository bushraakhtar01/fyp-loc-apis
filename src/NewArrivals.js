        ...
        <div className="container-fluid">
          ...
          {/* breadcrumb */}
            ...
            <li className="breadcrumb-item"><Link to="/mainpage" className="homebread">Home</Link></li>
              ...
              <li className="breadcrumb-item"><Link to="/newarrivals" className="homebread">New Arrivals</Link></li>
              <i className="right angle icon divider"></i>
...
<Link to="/stitched" className="navlinks"><li  onClick={function(){
             ...
             window.location.reload(true)
                ...
                <Link to="/stitched" className="navlinks"><li  onClick={function(){
             localStorage.removeItem("url")
             localStorage.setItem("url","https://pehnaway78.000webhostapp.com/api1/post/read.php/api/post/read.php")
             window.location.reload(true)
          }} >Sapphire</li></Link>  
