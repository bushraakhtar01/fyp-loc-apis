          ...
          <div className="container-fluid" >
              ...
              <div className="row">
                ...
                <div className="row" style={{padding:'3%'}} >
                    ...
                    <div className="card" className="gallerycard"  >
                     <img className="card-img"  src="khaadi.jpg"  ></img>
                   
                       <Link to = {{  pathname:'/UI'  }}>
         <h3 className="collectionheading" onClick={function(){
          ...
          }}>KHAADI COLLECTION</h3></Link>
                     </div>

                    </div>
                    <div className="col-md-3"   >
                    <div className="card"  className="gallerycard" >
                     <img className="card-img"  src="sapphire.jpg"  ></img>
                     <Link to = {{  pathname:'/UI'  }}>
         <h3 className="collectionheading" onClick={function(){
             localStorage.removeItem("url")
             ...
             localStorage.setItem("coverImg","sanaUI.jpg")
                   ...
                   <div className="col-md-3"  >
                   <div className="card" className="gallerycard"  >
                     <img className="card-img"  src="nishatgallery1.jpg"  ></img>
                     <Link to = {{  pathname:'/UI'  }}>
         <h3 className="collectionheading" onClick={function(){
             localStorage.removeItem("url")
          ...
          }}>NISHAAT COLLECTION</h3></Link>
                     </div>

                   </div>
                   <div className="col-md-3"  >
                   <div className="card" className="gallerycard"  >
                     <img className="card-img"  src="alkaram.jpg"  ></img>
                     <Link to = {{  pathname:'/UI'  }}>
         <h3 className="collectionheading" onClick={function(){
             localStorage.removeItem("url")
